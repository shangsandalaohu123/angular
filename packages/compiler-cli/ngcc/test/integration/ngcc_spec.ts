...
runInEachFileSystem(() => {
  describe('ngcc main()', () => {
    ...
    function setupAngularCoreEsm5() {
      ...
      const pkgJson = JSON.parse(fs.readFile(pkgJsonPath)) as any;
    ...
    describe('with ignoreEntryPointManifest', () => {
      it('should not read the entry-point manifest file', () => {
        ...
        let commonTesting =
            JSON.parse(fs.readFile(_('/node_modules/@angular/common/testing/package.json'))) as any;
        ...
        let manifest: EntryPointManifestFile =
            JSON.parse(fs.readFile(_('/node_modules/__ngcc_entry_points__.json'))) as any;
        ...
        // had removed earlier.
        manifest = JSON.parse(fs.readFile(_('/node_modules/__ngcc_entry_points__.json'))) as any;
    ...
    function loadPackage(
      ...
      return JSON.parse(fs.readFile(fs.resolve(basePath, packageName, 'package.json'))) as EntryPointPackageJson;
    }
