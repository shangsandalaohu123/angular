...
describe('@angular/common ng_package', () => {
  ...
  describe('should have module resolution properties in the package.json file for', () => {
    ...
    it('/', () => {
      const actual = JSON.parse(fs.readFileSync('package.json', {encoding: 'utf-8'})) as any;
      expect(actual['main']).toEqual('./bundles/common.umd.js');
    });
    // https://github.com/angular/common-builds/blob/master/http/package.json
    it('/http', () => {
      const actual = JSON.parse(fs.readFileSync('http/package.json', {encoding: 'utf-8'})) as any;
    ...
    it('/testing', () => {
      const actual = JSON.parse(fs.readFileSync('testing/package.json', {encoding: 'utf-8'}))  as any;
    ...
    it('/http/testing', () => {
      const actual = JSON.parse(fs.readFileSync('http/testing/package.json', {encoding: 'utf-8'}))  as any;
    ...
    it('/upgrade', () => {
      const actual = JSON.parse(fs.readFileSync('upgrade/package.json', {encoding: 'utf-8'})) as any;
